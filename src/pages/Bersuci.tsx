...
import {
    ...
    IonButton,
    IonIcon,
    IonButtons, IonModal, IonHeader, IonContent, IonToolbar, IonTitle, IonPage, IonApp
} from '@ionic/react';
...
const bersuciData = [
    {
        ...
        rujukan: ['Al-Nawawi, Abi Zakaria Mahy al-Din bin Syarf (t.t.). Al-Majmu’ Syarh al-Muhadhab li al-Syirazi. Juz. 1. Jeddah: Maktabah al-Irsyad.']
    },
    {
    ...
    },
    {
        ...
        rujukan: ['Al-Nawawi, Abi Zakaria Mahy al-Din bin Syarf (t.t.). Al-Majmu’ Syarh al-Muhadhab li al-Syirazi. Juz. 1. Jeddah: Maktabah al-Irsyad.', 'Al-Sharbini (1997). Mughni al-Muhtaj. Beirut: Dar al-Ma’rifah.', 'Al-Kasani, Abu Bakr bin Mas’ud bin Ahmad (1986). Bada’i’ al-Sana’i’ Fi Tartib al-Shara‘i’. Beirut: Dar al-Kutub al-‘Alamiyyah.']
    },
    {
        ...
        rujukan: ['Al-Nawawi, Abu Zakaria Mahyuddin Yahya bin Sharf (1392). Al-Minhaj Sharh Sahih Muslim bin al-Hujjaj Beirut: Dar Ihya’ al-Turath al-‘Arab']
    }
]
